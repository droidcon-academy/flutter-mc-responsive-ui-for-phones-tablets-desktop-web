...
class CartsModel {
  ...
  /// Load Sample Json Data from [cartsDataJson]
  factory CartsModel.loadDataJson() {
    return cartsModelFromJson(cartsDataJson);
  }

  static CartsModel cartsModelFromJson(String str) =>
      CartsModel.fromJson(json.decode(str));

  factory CartsModel.fromRawJson(String str) =>
      CartsModel.fromJson(json.decode(str));
...
class Cart {
  ...
  factory Cart.blankDefaultValues() {
    return Cart(
      id: 0,
      products: [],
      total: 0,
